package com.aptea.net.repository;

import com.aptea.net.BugTrackerJHipsterApp;
import com.aptea.net.config.Constants;
import com.aptea.net.config.audit.AuditEventConverter;
import com.aptea.net.domain.PersistentAuditEvent;
...
import static com.aptea.net.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
