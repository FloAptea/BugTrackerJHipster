package com.aptea.net.config.timezone;

import com.aptea.net.BugTrackerJHipsterApp;
import com.aptea.net.repository.timezone.DateTimeWrapper;
import com.aptea.net.repository.timezone.DateTimeWrapperRepository;
